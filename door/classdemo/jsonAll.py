...
class Demo:
    ...
    def demoJSONnewflow(self):
        ...
        userId = "p_zhhuasun"
        projectId = 1235
        data01 = {"id": "", "name": flowname, "userId": userId, "projectId": projectId, "canvasData": "",
                  "timerFlow": "false", "dispatchData":
                      "{\"periodSelect\":\"\",\"periodCount\":\"\",\"dispattime\":\"\",\"policy\":\"parallel\"}",
                  "edges": [], "nodes": []}
        tt = True;
        # 字典
