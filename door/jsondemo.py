...
class  Demo:
    ...
    def demoJSON(self):
        ...
        """
    def demoJSONnewflow(self):

        proresp_data = {"data": "{\"id\":1248,\"status\":\"success\",\"path\":\"manager?project=proname1903\",\"action\":\"redirect\"}","success": "true"}
        ...
        #['12', '11', '10']
        flowJson=
        {"id":"","name":"sdfsd","userId":"p_zhhuasun","projectId":1235,"canvasData":"","timerFlow":"false","dispatchData":
        "{\"periodSelect\":\"\",\"periodCount\":\"\",\"dispattime\":\"\",\"policy\":\"parallel\"}","edges":[],"nodes":[]}
        """
        flowname="sdfsd"
        userId="p_zhhuasun"
        projectId=1235
        data01 = {"id":"","name":flowname,"userId":userId,"projectId":projectId,"canvasData":"","timerFlow":"false","dispatchData":
        "{\"periodSelect\":\"\",\"periodCount\":\"\",\"dispattime\":\"\",\"policy\":\"parallel\"}","edges":[],"nodes":[]}
        tt = True;
        #字典
        dic01 = {"success": True, "data":data01 , "data02": "niceboy"}
        res01 = json.dumps(dic01)
        str01 = "data02"
        print(dic01[str01])
        print(res01)
    ...
    def gggg(self):
        ...
        print(proresp_data)
    def kkk(self):
        pppp={'data': '{"id":1248,"status":"success","path":"manager?project=proname1903","action":"redirect"}', 'success': True}
